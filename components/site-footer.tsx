  ...
  return <footer className="site-footer">
    <div className="site-footer-inner">
      <div className="site-footer-main">
        ...
        <div><b>START A JOURNEY</b><p>Tell us where you want to go. We will take care of the details.</p><Link className="footer-cta" href="/#booking">Plan your journey <ArrowUpRight size={17}/></Link></div>
      </div>
      <div className="site-social-row"><span>FOLLOW ANAN TRAVEL</span><div>{[[Facebook,'Facebook'],[Instagram,'Instagram'],[Music2,'TikTok'],[Youtube,'YouTube'],[Linkedin,'LinkedIn']].map(([Icon,name])=><a key={String(name)} href="#" aria-label={String(name)}><Icon size={18}/></a>)}</div></div>
